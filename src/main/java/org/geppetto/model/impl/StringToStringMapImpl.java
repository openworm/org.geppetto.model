...
public class StringToStringMapImpl extends MinimalEObjectImpl.Container implements BasicEMap.Entry<String,String>
{
	...
	{
		return GeppettoPackage.Literals.STRING_TO_STRING_MAP;
	}
	...
	public void setTypedKey(String newKey)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GeppettoPackage.STRING_TO_STRING_MAP__KEY, oldKey, key));
	}
	...
	public void setTypedValue(String newValue)
	{
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GeppettoPackage.STRING_TO_STRING_MAP__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case GeppettoPackage.STRING_TO_STRING_MAP__KEY:
				return getTypedKey();
			case GeppettoPackage.STRING_TO_STRING_MAP__VALUE:
