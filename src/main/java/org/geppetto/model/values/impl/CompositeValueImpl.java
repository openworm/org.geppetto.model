 ...
 * <ul>
 *   <li>{@link org.geppetto.model.values.impl.CompositeValueImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CompositeValueImpl extends ValueImpl implements CompositeValue
{
	...
	{
		return ValuesPackage.Literals.COMPOSITE_VALUE;
	}
	...
	public EMap<String, Value> getValue()
	{
		if (value == null)
		{
			value = new EcoreEMap<String,Value>(ValuesPackage.Literals.STRING_TO_VALUE_MAP, StringToValueMapImpl.class, this, ValuesPackage.COMPOSITE_VALUE__VALUE);
		}
		return value;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
	{
		switch (featureID)
		{
			case ValuesPackage.COMPOSITE_VALUE__VALUE:
