 ...
 * </p>
 * <ul>
 *   <li>{@link org.geppetto.model.values.impl.StringArrayImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StringArrayImpl extends AArrayValueImpl implements StringArray {
	/**
	...
	protected EClass eStaticClass() {
		return ValuesPackage.Literals.STRING_ARRAY;
	}
	...
	public EList<String> getElements() {
		if (elements == null)
		{
			elements = new EDataTypeEList<String>(String.class, this, ValuesPackage.STRING_ARRAY__ELEMENTS);
		}
		return elements;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID)
		{
			case ValuesPackage.STRING_ARRAY__ELEMENTS:
				return getElements();
		}
