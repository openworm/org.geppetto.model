 ...
 * <ul>
 *   <li>{@link org.geppetto.model.values.impl.ArrayValueImpl#getElements <em>Elements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ArrayValueImpl extends ValueImpl implements ArrayValue
{
	...
	{
		return ValuesPackage.Literals.ARRAY_VALUE;
	}
	...
	public EList<ArrayElement> getElements()
	{
		if (elements == null)
		{
			elements = new EObjectContainmentEList<ArrayElement>(ArrayElement.class, this, ValuesPackage.ARRAY_VALUE__ELEMENTS);
		}
		return elements;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
	{
		switch (featureID)
		{
			case ValuesPackage.ARRAY_VALUE__ELEMENTS:
