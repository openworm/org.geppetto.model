 ...
 * <ul>
 *   <li>{@link org.geppetto.model.variables.impl.ArrayVariableImpl#getSize <em>Size</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ArrayVariableImpl extends VariableImpl implements ArrayVariable
{
	...
	public void setSize(int newSize)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VariablesPackage.ARRAY_VARIABLE__SIZE, oldSize, size));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case VariablesPackage.ARRAY_VARIABLE__SIZE:
				return getSize();
		}
