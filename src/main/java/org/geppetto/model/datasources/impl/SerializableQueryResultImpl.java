 ...
 * </p>
 * <ul>
 *   <li>{@link org.geppetto.model.datasources.impl.SerializableQueryResultImpl#getValues <em>Values</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SerializableQueryResultImpl extends AQueryResultImpl implements SerializableQueryResult
{
	...
	{
		return DatasourcesPackage.Literals.SERIALIZABLE_QUERY_RESULT;
	}
	...
	public EList<String> getValues()
	{
		if (values == null)
		{
			values = new EDataTypeEList<String>(String.class, this, DatasourcesPackage.SERIALIZABLE_QUERY_RESULT__VALUES);
		}
		return values;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case DatasourcesPackage.SERIALIZABLE_QUERY_RESULT__VALUES:
				return getValues();
		}
