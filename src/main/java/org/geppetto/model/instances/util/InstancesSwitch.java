...
public class InstancesSwitch<T> extends Switch<T>
{
	...
	protected T doSwitch(int classifierID, EObject theEObject)
	{
		switch (classifierID)
		{
			case InstancesPackage.INSTANCE:
			{
				...
				if (result == null) result = caseISynchable(instance);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case InstancesPackage.SIMPLE_INSTANCE:
			{
				...
				if (result == null) result = caseNode(simpleInstance);
				if (result == null) result = caseISynchable(simpleInstance);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case InstancesPackage.SIMPLE_CONNECTION_INSTANCE:
			{
				SimpleConnectionInstance simpleConnectionInstance = (SimpleConnectionInstance)theEObject;
				T result = caseSimpleConnectionInstance(simpleConnectionInstance);
				if (result == null) result = caseInstance(simpleConnectionInstance);
				if (result == null) result = caseNode(simpleConnectionInstance);
				if (result == null) result = caseISynchable(simpleConnectionInstance);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Simple Connection Instance</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Simple Connection Instance</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSimpleConnectionInstance(SimpleConnectionInstance object)
	{
		return null;
	}
