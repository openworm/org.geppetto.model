...
public class ParameterTypeImpl extends TypeImpl implements ParameterType
{
		...
		if (defaultValue != null && defaultValue.eIsProxy())
		{
			...
			if (defaultValue != oldDefaultValue)
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TypesPackage.PARAMETER_TYPE__DEFAULT_VALUE, oldDefaultValue, defaultValue));
			}
		}
		return defaultValue;
	}
	...
	public void setDefaultValue(Quantity newDefaultValue)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypesPackage.PARAMETER_TYPE__DEFAULT_VALUE, oldDefaultValue, defaultValue));
	}
