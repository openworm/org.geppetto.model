...
public class DynamicsTypeImpl extends TypeImpl implements DynamicsType
{
	...
	public NotificationChain basicSetDefaultValue(Dynamics newDefaultValue, NotificationChain msgs)
	{
		...
		{
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TypesPackage.DYNAMICS_TYPE__DEFAULT_VALUE, oldDefaultValue, newDefaultValue);
	...
	public void setDefaultValue(Dynamics newDefaultValue)
	{
		if (newDefaultValue != defaultValue)
		{
			...
			if (defaultValue != null)
				msgs = ((InternalEObject)defaultValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TypesPackage.DYNAMICS_TYPE__DEFAULT_VALUE, null, msgs);
			if (newDefaultValue != null)
				msgs = ((InternalEObject)newDefaultValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TypesPackage.DYNAMICS_TYPE__DEFAULT_VALUE, null, msgs);
			msgs = basicSetDefaultValue(newDefaultValue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypesPackage.DYNAMICS_TYPE__DEFAULT_VALUE, newDefaultValue, newDefaultValue));
	}
