...
public class PointerTypeImpl extends TypeImpl implements PointerType
{
	 ...
	 * @generated
	 */
	public NotificationChain basicSetDefaultValue(Pointer newDefaultValue, NotificationChain msgs)
	{
		Pointer oldDefaultValue = defaultValue;
		defaultValue = newDefaultValue;
		if (eNotificationRequired())
		{
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TypesPackage.POINTER_TYPE__DEFAULT_VALUE, oldDefaultValue, newDefaultValue);
	...
	public void setDefaultValue(Pointer newDefaultValue)
	{
		if (newDefaultValue != defaultValue)
		{
			...
			if (defaultValue != null)
				msgs = ((InternalEObject)defaultValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TypesPackage.POINTER_TYPE__DEFAULT_VALUE, null, msgs);
			if (newDefaultValue != null)
				msgs = ((InternalEObject)newDefaultValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TypesPackage.POINTER_TYPE__DEFAULT_VALUE, null, msgs);
			msgs = basicSetDefaultValue(newDefaultValue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypesPackage.POINTER_TYPE__DEFAULT_VALUE, newDefaultValue, newDefaultValue));
	}
